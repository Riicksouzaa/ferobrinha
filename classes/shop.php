...
class Shop extends ObjectData
{
    ...
    {
        $this->data['offer_description'] = $desc;
    }
    ...
    {
        $this->data['offer_date'] = $date;
    }
    
    public function getDate ()
    {
        return $this->data['offer_date'];
    }
    
    public function setDefaultImage ($default)
    {
        $this->data['default_image'] = $default;
    }
