...
$main_content .= '
<TR><TD style="width: 20%">Company Website:</TD><TD>www.ferobraglobal.com</A></TD></TR>
<TR><TD style="width: 20%">Managing Director:</TD><TD>Ricardo Souza</TD></TR>';
...
$main_content .= "<div class='TableContainer'>";
$main_content .= $make_content_header("Ferobra Members");
$main_content .= $make_table_header();
