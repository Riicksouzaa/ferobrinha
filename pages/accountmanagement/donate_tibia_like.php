...
if ($logged) {
    ...
    <table class="Table5" cellpadding="0" cellspacing="0">
        ...
        foreach ($config['donate']['offers'] as $reais => $coins){
            $main_content .='
                                                                    <div class="ServiceID_Icon_Container" id="ServiceID_Icon_Container_'.$reais.'">
                                                                        <div class="ServiceID_Icon_Container_Background" id="" style="background-image:url('.$layout_name.'/images/payment/serviceid_icon_normal.png);">
                                                                            <div class="ServiceID_Icon" id="ServiceID_Icon_'.$reais.'" style="" onclick="ChangeService('.$reais.', 13);" onmouseover="MouseOverServiceID('.$reais.', 13);" onmouseout="MouseOutServiceID('.$reais.', 13);">
                                                                                <div class="PermanentDeactivated ServiceID_Deactivated_ByChoice" id="ServiceID_NotAllowed_'.$reais.'" style="display: none;">
                                                                                ...
                                                                                <div class="ServiceID_Icon_New" id="ServiceID_Icon_New_'.$reais.'" style="background-image:url('.$layout_name.'/images/payment/serviceid_'.$countOffers.'.png);"></div>
                                                                                <div class="ServiceID_Icon_Selected" id="ServiceID_Icon_Selected_'.$reais.'"></div>
                                                                                <div class="ServiceID_Icon_Over" id="ServiceID_Icon_Over_'.$reais.'" style=""></div>
                                                                                <label for="ServiceID_'.$reais.'">
                                                                                    <div class="ServiceIDLabelContainer">
                                                                                        <div class="ServiceIDLabel">    <input type="radio" id="ServiceID_'.$reais.'" name="ServiceID" value="'.$reais.'" style="display: none;">'.$coins.' Coins  </div>
                                                                                    </div>
                                                                                    <div class="ServiceIDPriceContainer"><span class="ServiceIDPrice" id="PD_'.$reais.'">R$ '.($reais/100).'.00</span></div>
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <table class="TableContent" width="100%" style="border:1px solid #faf0d7;">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>'.$payment_data["ServiceID"].' Tibia Coins</td>
                                                        </tr>
                                                        <tr>
