...
foreach($players_online_data as $player)
{
	...
	<div class="TopButtonContainer" >
		<div class="TopButton">
			<a href="#top" ><image style="border:0px;" src="'.$layout_name.'/images/global/content/back-to-top.gif" />
			</a>
		</div>
	</div>
	...
	<br>
		...
		<div class="TableShadowContainer" style="top: -3px;width: 98.5%;margin-left: 6px;">
