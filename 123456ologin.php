...
case "news":
        $categorycounts = [
            'CLIENT FEATURES' => 1, // patch notes
            'GAME CONTENTS' => 1, //
            'MAJOR UPDATES' => 1, //
            'SUPPORT' => 1, //
            'USEFUL INFO' => 1 // bug fixes
        ];
        $gamenews = [
        [
        'campaignid' => '0',
        ...
        'id' => '1',
        'index' => '1',
        'message' => '<center><table style="height: 88px;" width="406"><tbody><tr><td style="width: 396px; vertical-align: top;"><center><p><img src="https://pics.me.me/porn-brazzer-s-com-6k-2k-add-to-share-download-dillion-48214021.png" width="304" height="652"/> </p> <p>Eu vou dominar o mundo rapaz</p></center></td></tr></tbody></table></center>', // LIMITE 665 HORIZONTAL, INFINITO VERTICAL
        'publishdate' => time(),
        'type' => 'REGULAR',
        ]];
    ...
    case "categorycounts":
        ...
        [
                ...
                $schedule['idOfNewestReadEntry'] = 3;
                $schedule['isreturner'] = false;
