...
<!--                                                <img src="--><?php //echo $layout_name; ?><!--\images\global\themeboxes\networks\tibia-facebook-page-logo.png" /></a>-->
                                                <img style="width: 50px; height: 50px;" src="<?= $config['social']['fbapilink']?><?= $config['social']['fbapiversion']?>/<?= $config['social']['fbpageid']?>/picture?access_token=<?= $config['social']['accessToken']?>" /></a>
